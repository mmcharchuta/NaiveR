...
RcppExport SEXP _NaiveR_calculate_log_probability(SEXP kmer_genus_countSEXP, SEXP word_specific_priorsSEXP, SEXP genus_countsSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_NaiveR_calculate_log_probability", (DL_FUNC) &_NaiveR_calculate_log_probability, 3},
    {NULL, NULL, 0}
};

RcppExport void R_init_NaiveR(DllInfo *dll) {
